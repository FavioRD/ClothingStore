...
import { X, Plus, Dash, Bag } from 'react-bootstrap-icons'; // Iconos corregidos
            ...
            <div className="product-details">
              ...
              {product.colors?.length > 0 && (
                <div className="option-section mb-4">
                  <h6 className="option-title">Color: <span className="selected-option">{selectedColor}</span></h6>
              ...
              {product.sizes?.length > 0 && (
                <div className="option-section mb-4">
                  <h6 className="option-title">Talla: <span className="selected-option">{selectedSize}</span></h6>
